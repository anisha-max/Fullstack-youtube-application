  ...
  useEffect(() => {
    const profile = async () => {
      try {
        ...
        setSubscriber(response.subscriberCount)
      } catch (error) {
      ...
      <div className="mt-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          {user?.videos?.length > 0 ? (
            ...
            <div className="col-span-full aspect-video bg-slate-50 rounded-2xl border-2 border-dashed border-slate-200 flex items-center justify-center text-slate-400">
